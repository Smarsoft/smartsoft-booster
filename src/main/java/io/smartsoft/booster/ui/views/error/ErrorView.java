...
import io.smartsoft.booster.utils.HTTPErrorStatusCodes;
...
public class ErrorView extends LinearLayout {
    ...
    private void init() {
        ...
        try {
            errorImageRes = a.getResourceId(R.styleable.ErrorView_ev_errorImage,
                    R.drawable.error_view_cloud);
            ...
            retryButtonBackground = a.getResourceId(R.styleable.ErrorView_ev_retryButtonBackground,
                    R.drawable.bg_error_view_retry_button);
    ...
    public void setError(int errorCode) {
        Map<Integer, String> mCodes = HTTPErrorStatusCodes.getCodesMap();
